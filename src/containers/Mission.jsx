...
const Mission = () => {
	...
	return (
		<div className="w-[90%] h-[40vh] lg:h-[100vh] mx-auto relative rounded-lg overflow-clip" ref={containerRef}>
			...
			<div className="w-full px-[10%] mx-auto absolute top-10 flex items-stretch justify-between">
				...
				<div className="hidden lg:block p-8 bg-white rounded-full transition-all duration-500 ease-in-out hover:scale-125 group">
					<img src={NavigateSvg} alt="" className="w-8 transition-all duration-200 ease-in-out group-hover:rotate-45" />
				</div>
			</div>
